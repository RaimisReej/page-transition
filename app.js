...
const leaveAnimation = (current,done) => {
    ...
    return (
        ...
        tlLeave.fromTo(circles, {y: 0, opacity: 1}, {opacity: 0, y: -200, stagger: 0.15, ease: 'back.out(1.7)'}, '<')
    )
}
const enterAnimation = (current,done, gradient) => {
    ...
    return (
        ...
        tlEnter.fromTo(circles, {y: -200, opacity: 0}, {opacity: 1, y: 0, stagger: 0.15, ease: 'back.out(1.7)'}, '<')
    )
}
